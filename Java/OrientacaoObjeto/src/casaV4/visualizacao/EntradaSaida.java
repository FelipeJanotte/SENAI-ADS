package casaV4.visualizacao;

import casaV4.modelo.Aberturas;
...
public class EntradaSaida {
    ...
    public static void exibeInforCasa(String informacoes) {
        JOptionPane.showMessageDialog(null, informacoes, "Informacoes da casa", JOptionPane.INFORMATION_MESSAGE);
    }
}
